...
writeup in [`burst_diffusion/README.md`](../README.md), full
documentation in [`burst_diffusion_report.md`](burst_diffusion_report.md)
(experiment report), [`burst_diffusion_guide.md`](burst_diffusion_guide.md)
(user guide), and [`burst_diffusion_method.md`](burst_diffusion_method.md)
...
runs trained and evaluated (`burst_diffusion/configs/*_p10.yml`, 30k steps,
