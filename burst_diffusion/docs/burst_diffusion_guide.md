...
Config reference (`burst_diffusion/configs/*.yml`; unknown keys are rejected):
...
```powershell
python -m burst_diffusion train --config burst_diffusion/configs/bbbc038_p10_rollout.yml `
...
```powershell
python -m burst_diffusion repeatability --config burst_diffusion/configs/miic_p10.yml `
...
```powershell
python -m burst_diffusion provenance --config burst_diffusion/configs/miic_p10_dedup.yml `
  --command "python -m burst_diffusion train --config burst_diffusion/configs/miic_p10_dedup.yml"
```
