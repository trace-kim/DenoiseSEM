...
from runctl.profiles import load_profile, profile_path, save_profile, user_config_dir
from runctl.schemas import ExecutorType, MachineProfile, SlurmResources
...
def test_standard_platform_configuration_paths() -> None:
    ...
    ) == Path("C:/Users/alice/AppData/Roaming/runctl")
    assert user_config_dir(
        environ={"XDG_CONFIG_HOME": "/configuration"},
        platform="linux",
        home=Path("/home/alice"),
    ) == Path("/configuration/runctl")
